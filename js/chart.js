(function() {
  ...
  function setup() {
    ...
    var labels = [
      ...
      { text: 'Acoustic-Mainstream', horizontal: 'right', vertical: 'top', x: width, y: 0 },
      { text: 'Folk', horizontal: 'left', vertical: 'middle', x: 0, y: height / 2 },
      // { text: 'Centerism', horizontal: 'center', vertical: 'middle', x: width / 2, y: height / 2 },
      { text: 'Mainstream', horizontal: 'right', vertical: 'middle', x: width, y: height / 2 },
      { text: 'Synthesized-Folk', horizontal: 'left', vertical: 'bottom', x: 0, y: height },
      { text: 'Synthesized', horizontal: 'center', vertical: 'bottom', x: width / 2, y: height },
      { text: 'Synthesized-Mainstream', horizontal: 'right', vertical: 'bottom', x: width, y: height },
    ];
